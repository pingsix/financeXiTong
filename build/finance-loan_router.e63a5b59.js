...
/***/ function(module, exports, __webpack_require__) {
	...
	var dependArr = [__webpack_require__(147).default.name];
	exports.default = {
	...
	function controller(_, service, $timeout, $state, util, $q) {
	  ...
	  */
	  ...
	  function paddingData(data) {
	    var presentStatusList = [{ id: '正常', value: '正常' }, { id: '逾期', value: '逾期' }, { id: '已结清', value: '已结清' }, { id: '一次还清', value: '一次还清' }, { id: '取消借款', value: '取消借款' }, { id: '代偿', value: '代偿' }, { id: '代偿结清', value: '代偿结清' }],
	        loanStatusList = [{ id: '成功', value: '成功' }, { id: '失败', value: '失败' }, { id: '待放款', value: '待放款' }];
	    return {
